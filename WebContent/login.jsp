...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html">
	...
	<form method="post" action="S1">
	  ...
	  <tr>
		<td align="right" style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;color:#000080; font-weight:bold ">Authentification</td>
	  </tr>
	  <tr>
		<td id="logina" valign="bottom" align="center">
			...
			<table width="209"  border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
			      ...
			      <td width="60%"><input type="text" name="txt_login" id="txt_login" class="zonetexte"></td>
			  </tr>
				<tr>
					<td height="26" id="chapms">Mot de passe </td>
					<td>
						<input type="password" name="txt_password" id="txt_password" class="zonetexte">					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td align="right">
					<input type="submit" name="Submit" id="Submit" value=" Valider " class="button">					</td>
				</tr>
		  </table>
	...
	<%}else{ %><jsp:forward page="index.jsp"></jsp:forward><%} %>
	</html>
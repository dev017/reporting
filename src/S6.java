...
public class S6 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		super.init();
		   ...
		   TypeContratService tcSer=new TypeContratService();
		   tcSer.typeContratService();
...
// ok   
     JasperDesign jasperDesign = JRXmlLoader.load("E:\\type_contrat_service.bak");
  ...
  //   String jasperDesign ="D:\\iReport-2.0.3\\services.jasper";
   ...
   String filename = "Type_Contrat_Service";

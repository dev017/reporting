...
public class S5 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		super.init();
		   ...
		   AbsenceService abSer=new AbsenceService();
		   abSer.absenceService();
...
//      Connection connection = DriverManager.getConnection(url, login, password);
   ...
   // ok   
        JasperDesign jasperDesign = JRXmlLoader.load("E:\\absence_service.bak");
     ...
     //   String jasperDesign ="D:\\iReport-2.0.3\\services.jasper";
      ...
      String filename = "C:\\Absence_Service";
